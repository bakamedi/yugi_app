...
_$YugiCardModelImpl _$$YugiCardModelImplFromJson(Map<String, dynamic> json) =>
    _$YugiCardModelImpl(
...
Map<String, dynamic> _$$YugiCardModelImplToJson(_$YugiCardModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
      'meta': instance.meta,
    };
...
_$BanlistInfoImpl _$$BanlistInfoImplFromJson(Map<String, dynamic> json) =>
    _$BanlistInfoImpl(
      banTcg: json['ban_tcg'] as String?,
      banOcg: json['ban_ocg'] as String?,
    );

Map<String, dynamic> _$$BanlistInfoImplToJson(_$BanlistInfoImpl instance) =>
    <String, dynamic>{
